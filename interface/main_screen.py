...
class MainScreen:
    def __init__(self):
        ...
        self.controls_frame = tk.Frame(self._main_frame)
    ...
    def controller_width(self):
        ...
        tk.Label(self.controls_frame, text="Largura (%)").pack()
    ...
    def controller_height(self):
        ...
        tk.Label(self.controls_frame, text="Altura (%)").pack()
    ...
    def start_capture(self):
        ...
        self.recognizer.update_video_frame()

    def starter_button(self):
        """Botão para iniciar a captura."""
        start_button = tk.Button(self.controls_frame, text="Iniciar Captura", command=self.start_capture)
